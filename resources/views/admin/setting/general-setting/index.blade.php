                            ...
                            <form action="{{ route('admin.general-setting.update', 1) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <img src="{{ asset($setting->logo) }}" alt="" style="width:200px">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Footer Logo
                                        Preview</label>
                                    <div class="col-sm-12 col-md-7">
                                        <img src="{{ asset($setting->footer_logo) }}" alt="" style="width:200px">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Favicon
                                        Preview</label>
                                    <div class="col-sm-12 col-md-7">
                                        <img src="{{ asset($setting->favicon) }}" alt="" style="width:200px">
                                    </div>
                                </div>


                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Footer Favicon
                                        Preview</label>
                                    <div class="col-sm-12 col-md-7">
                                        <div class="custom-file">
